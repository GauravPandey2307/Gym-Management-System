...
<form id="event" name="event" method="POST" action="events_action.php" onsubmit="return validate(this)">
<table width="1091" height="336" align="center" bgcolor="#FFFFFF">
  ...
  <tr>
    ...
    <td width="900"><label>
      ...
      <p align="center"><span class="style4">Add Event Details     </span></p>
      <table width="309" height="117" border="3" align="center" bordercolor="#000000" bgcolor="#9999CC">

        <tr>
          <td><div align="center" class="style5">Circular No. </div></td>
          <td><div align="center">
            <label>
        ...
        <tr>
          <td><div align="center" class="style5">Event Details </div></td>
          <td><div align="center">
            <label>
