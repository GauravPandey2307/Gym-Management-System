...
<table width="1091" height="336"  align="center">
  ...
  <tr>
    ...
    <td width="900">
      ...
      <p align="center" class="style6">Suppliers Details </p>
      <table width="882" height="89" border="3" align="center" bordercolor="#000000" bgcolor="#9999CC">
	    <tr>
		  <td width="81"><div align="center"><strong>Supplier ID</strong></div></td>
		  <td width="92"><div align="center"><strong>Name</strong></div></td>
		  <td width="93"><div align="center"><strong>Company Name</strong></div></td>
		  <td width="104"><div align="center"><strong>Product</strong></div></td>
...
<?php include("connect.php"); ?>
 <?php
		...
		<td><center><?php echo $row[0]; ?> </center></td>
		 ...
		 <td><center><?php echo "<a href='supp_detail_delete.php?sup_id=$row[0]'>Delete Detail</a>"; ?></center></td>
