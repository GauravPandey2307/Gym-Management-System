...
<form id="emp_detail" name="emp_detail" method="POST" action="emp_detail_action.php" onsubmit="return validate(this)">
<table width="1091" height="336" align="center">
  ...
  <tr>
    ...
    <td width="900" bgcolor="#FFFFFF"><label>
        ...
        <p align="center" class="style2">TRAINER DETAILS</p>
        <table width="340" height="290" border="3" align="center" bordercolor="#000000" bgcolor="#9999CC">
          
          <tr>
            <td width="135" height="36"><div align="center">TRAINER ID </div></td>
            <td width="187"><label>
